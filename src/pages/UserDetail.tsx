...
const UserDetail = () => {
    ...
    return (
      <Layout>
        <div className="py-8 px-4 max-w-4xl mx-auto text-center">
          ...
          <Button onClick={() => navigate("/")} variant="outline">Back to Users</Button>
        </div>
      </Layout>
    );
  }
  ...
  const handleWhatsApp = () => {
    const message = encodeURIComponent(`Hi ${user.name.first}, I found your profile and would like to connect!`);
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                <Button size="lg" className="flex-1">Contact Now</Button>
                <Button
                  size="lg"
                  variant="outline"
